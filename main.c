...
//Henrique Barros de Almeida e Lucas Abrahão
    ...
    if(opcao==1){
        ...
        if(opcao2==1){
            ...
            if(max<7){
                ...
                printf("3 - Retornar ao Menu de manipula��o\n");
                printf ("-> ");
                scanf("%d",&opcao);
                if(opcao==1){
                    goto menu_cadastro;
                ...
                printf("2 - Retornar ao Menu de manipula��o\n");
                printf ("-> ");
                scanf("%d",&opcao);
                if(opcao==1){
                    goto gerenciador_menu;
